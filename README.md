...
- This project is designed to work **only with a Gmail address**, because it uses Gmail's SMTP server (`smtp.gmail.com`) to send emails. Simply entering the email and password will not work. To make it work:
